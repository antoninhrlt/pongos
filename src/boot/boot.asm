...
; Modified from https://github.com/antoninhrlt/osmini/blob/main/bootloader/src/boot.asm
...
start:
    ...
    ; Jump to the system core
    jmp dword 0x8:0x1000 ; code segment reset

; ---
hello_msg: db "[pongos] Core loading", 13, 10, 0
gdt_msg: db "[pongos] GDT initializing", 13, 10, 0
mode_msg: db "[pongos] Protected mode entering", 13, 10, 0
